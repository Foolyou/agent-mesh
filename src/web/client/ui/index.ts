...
// C5 = primitives; C6 = surfaces/lists/states; C7 = conversation/domain. Gallery is C8.
...
// C7 — conversation / domain primitives
export { ApprovalCard, type ApprovalCardProps, type ApprovalOption } from "./ApprovalCard";
